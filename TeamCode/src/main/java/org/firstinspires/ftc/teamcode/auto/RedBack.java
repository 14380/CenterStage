...
public class RedBack extends AutoOpBase {
    ...
    public void initialize() {
        ...
        TrajectorySequence moveForward = drive.trajectorySequenceBuilder(startingPosition)
                ...
                .lineToSplineHeading(new Pose2d(-36,-33, Math.toRadians(90)))
                .lineToSplineHeading(new Pose2d(-36,-43, Math.toRadians(90)))
        ...
        TrajectorySequence moveToLeft = drive.trajectorySequenceBuilder(startingPosition)
                ...
                .lineToSplineHeading(new Pose2d(-24, -25, Math.toRadians(90)))
                .lineToSplineHeading(new Pose2d(-40,0, Math.toRadians(180)))
        ...
        TrajectorySequence moveToRight = drive.trajectorySequenceBuilder(startingPosition)
                .lineToSplineHeading(new Pose2d(-32, -31, Math.toRadians(45)))
                .lineToSplineHeading(new Pose2d(-32, -40, Math.toRadians(45)))
                .lineToSplineHeading(new Pose2d(-45, -40, Math.toRadians(45)))
                .lineToSplineHeading(new Pose2d(-40,0, Math.toRadians(180)))
                .build();
